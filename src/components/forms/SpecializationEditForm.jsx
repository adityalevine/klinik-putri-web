...
export const SpecializationEditForm = ({ isOpen, onClose }) => {
  ...
  const fetchSpecializations = async () => {
    try {
      const specializationResponse = await axiosInstance.get("/reservations/" + userSelector.id);
      ...
      <Dialog open={isOpen} onOpenChange={onClose}>
        <DialogContent className="sm:max-w-md">
          <DialogHeader className="h-20 flex justify-center px-10 bg-[#159030] text-white rounded-t">
            <DialogTitle className="text-2xl font-semibold">Edit Data</DialogTitle>
          </DialogHeader>
          <Form {...form}>
