    ...
    <footer className="w-full bg-white border-t">
      <div className="container mx-auto flex flex-col md:flex-row justify-between items-center md:h-36 px-5 md:px-32 py-6 md:py-0 text-gray-500">
        <div className="text-center md:text-left">
          <h4 className="text-xl font-semibold mb-3 text-black">Klinik Putri</h4>
          <p className="mb-8">
        ...
        <div className="text-center md:text-left mb-6 md:mb-0">
          <h4 className="text-xl font-semibold mb-3 text-black">Menu</h4>
        ...
        <div className="text-center md:text-left">
          <h4 className="text-xl font-semibold mb-3 text-black">Hubungi Kami</h4>
          <div className="flex flex-col gap-2">
